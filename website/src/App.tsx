    ...
    <div className="bg-background text-on-background font-body-preview min-h-screen flex flex-col antialiased overflow-x-hidden">
      ...
      <nav className="flex justify-between items-center px-4 md:px-6 lg:px-xl h-16 w-full border-b border-outline-variant bg-background/80 backdrop-blur-md sticky top-0 z-50">
        ...
        <div className="flex items-center gap-4 md:gap-8">
          <a className="font-mono-ui text-base font-semibold text-on-surface-variant hover:text-on-surface hidden md:block" href="https://github.com/username/mind-md">GitHub</a>
      ...
      <main className="flex-grow">
        ...
        <section className="px-6 lg:px-xl py-24 md:py-32 flex flex-col items-center text-center max-w-5xl mx-auto relative">
          ...
          <div className="flex flex-col sm:flex-row gap-md w-full justify-center">
            <button className="bg-primary text-background font-h2 font-semibold text-h2 px-lg py-sm rounded-DEFAULT hover:brightness-110 transition-all flex items-center justify-center gap-sm">
              Get 🧠.md
              <ArrowRight className="w-5 h-5" />
            </button>
            <button className="bg-transparent border border-outline-variant text-on-background font-h2 text-h2 px-lg py-sm rounded-DEFAULT hover:bg-surface-container-low transition-all">
              View Documentation
            </button>
          </div>
